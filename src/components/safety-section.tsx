...
const plans = [
  {
    ...
    price: "от 290",
    unit: "сомони",
    description: "Один рекламный ролик для теста",
    features: ["1 AI Reels до 15 сек", "1 правка", "Музыка и субтитры", "Формат для Instagram/TikTok"],
    popular: false,
  },
  {
    name: "Бизнес",
    price: "от 690",
    unit: "сомони",
    description: "Пакет для активного продвижения",
    features: ["3 ролика на выбор", "3 правки", "Монтаж и брендинг", "Product / Promo / Reels", "Приоритетный срок"],
    popular: true,
  },
  {
    name: "Бренд",
    price: "Индивидуально",
    unit: "",
    description: "Полное сопровождение бренда",
    features: ["Ролики под ключ ежемесячно", "Безлимит правок", "Контент-стратегия", "Личный менеджер"],
    popular: false,
  },
]
